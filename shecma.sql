...
-- Şifre: 'admin123' (İlk kurulumdan sonra fix_admin_password.py dosyasını çalıştırarak şifreyi hash'leyin)
-- NOT: İlk giriş düz metin şifreyi otomatik hash'leyecektir, ancak manuel olarak fix_admin_password.py çalıştırmanız önerilir
...
INSERT INTO classrooms (department_id, code, name, capacity, rows_count, cols_count, seating_type) VALUES
    ...
    (1, '3004', 'EDA', 30, 6, 5, 2),
    (1, '3005', '305', 42, 7, 3, 3),
    (1, '3006', '306', 150, 15, 10, 2),
    (1, '3007', '307', 150, 15, 10, 2),
    (1, '3008', '308', 150, 15, 10, 2),
    (1, '3009', '309', 150, 15, 10, 2),
    (1, '3010', '310', 150, 15, 10, 2),
    (1, '3011', '311', 150, 15, 10, 2),
    (1, '3012', '312', 150, 15, 10, 2),
    (1, '3013', '313', 150, 15, 10, 2),
    (1, '3014', '314', 150, 15, 10, 2),
    (1, '3015', '315', 150, 15, 10, 2),
    (1, '3016', '316', 150, 15, 10, 2),
    (1, '3017', '317', 150, 15, 10, 2),
    (1, '3018', '318', 150, 15, 10, 2)
